...
public class TwitterElasticQueryService implements ElasticQueryService {
    ...
    @Override
    public ElasticQueryServiceAnalyticsResponseModel getDocumentByText(String text) {
    ...
    private Long getWordCount(String text) {
        if (QueryType.KAFKA_STATE_STORE.getType().equals(elasticQueryServiceConfigData.getWebClient().getQueryType())) {
            ...
            return getFromAnayticsDatabase(text).getWordCount();
        }
        return 0L;
    }

    private ElasticQueryServiceWordCountResponseModel getFromAnayticsDatabase(String text) {
