...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public void start() throws TwitterException {
        ...
        LOG.info("starting mock twitter streams for keywords {}", Arrays.toString(keywords));
    ...
    private void sleep(long sleepTimeMs) {
        try {
            ...
            throw new TwitterToKafkaServiceException("Error while sleeping for waiting to create new threads");
        }
    }
